...
type exp =
  ...
  | I_interval (* primary_exp *) of
      unaryOp option * string * unaryOp option * string
  (**)
  | I_incr (* postfix_exp *) of exp (* primary_exp/postfix_exp *) annotated
  | I_decr (* postfix_exp *) of exp (* primary_exp/postfix_exp *) annotated
  | I_call (* postfix_exp *) of
      exp (* primary_exp/postfix_exp *) annotated * exp annotated list
  (**)
  ...
  | I_unary (* unary_exp *) of
      unaryOp * exp (* postfix_exp/unary_exp *) annotated
  (**)
  | I_mul (* mul_exp *) of
      exp (* unary_exp/mul_exp *) annotated * exp (* unary_exp *) annotated
  | I_div (* mul_exp *) of
      exp (* unary_exp/mul_exp *) annotated * exp (* unary_exp *) annotated
  | I_mod (* mul_exp *) of
      exp (* unary_exp/mul_exp *) annotated * exp (* unary_exp *) annotated
  (**)
  | I_add (* add_exp *) of
      exp (* mul_exp/add_exp *) annotated * exp (* mul_exp *) annotated
  | I_minus (* add_exp *) of
      exp (* mul_exp/add_exp *) annotated * exp (* mul_exp *) annotated
  (**)
  | I_less (* relational_exp *) of
      exp (* add_exp/relational_exp *) annotated * exp (* add_exp *) annotated
  | I_leq (* relational_exp *) of
      exp (* add_exp/relational_exp *) annotated * exp (* add_exp *) annotated
  | I_greater (* relational_exp *) of
      exp (* add_exp/relational_exp *) annotated * exp (* add_exp *) annotated
  | I_geq (* relational_exp *) of
      exp (* add_exp/relational_exp *) annotated * exp (* add_exp *) annotated
  (**)
  | I_eq (* equality_exp *) of
      exp (* relational_exp/equality_exp *) annotated
      * exp (* relational_exp *) annotated
  | I_neq (* equality_exp *) of
      exp (* relational_exp/equality_exp *) annotated
      * exp (* relational_exp *) annotated
  (**)
  | I_and (* logical_and_exp *) of
      exp (* equality_exp/logical_and_exp *) annotated
      * exp (* equality_exp *) annotated
  (**)
  | I_or (* logical_or_exp *) of
      exp (* logical_and_exp/logical_or_exp *) annotated
      * exp (* logical_and_exp *) annotated
  (**)
...
type stmt =
  ...
  | I_for_simple of
      exp annotated * exp annotated * exp annotated * stmt annotated
  | I_for of
      globalDecl annotated * exp annotated * exp annotated * stmt annotated
...
and functionDecl =
  typ annotated option
  * string annotated
  * (typ annotated * string annotated) list
  * stmt annotated list
